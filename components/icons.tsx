...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const ScriptIcon: React.FC<React.SVGProps<any>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const MicIcon: React.FC<React.SVGProps<any>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const BackIcon: React.FC<React.SVGProps<any>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const DownloadIcon: React.FC<React.SVGProps<any>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const ReplayIcon: React.FC<React.SVGProps<any>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const VideoIcon: React.FC<React.SVGProps<any>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const EyeIcon: React.FC<React.SVGProps<any>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Fix: Use 'any' for SVG element type to resolve 'Cannot find name SVGSVGElement' error when 'dom' lib is not included.
export const TrashIcon: React.FC<React.SVGProps<any>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
